...
### Changed
- Replaced hard-coded API payload values of `'format': 'json'` with the shared `@optional_field('format', "json")` decorator across API request builders for consistent default handling.
